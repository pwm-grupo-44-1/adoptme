# Estructura del código: los COMPONENTES y su funcionalidad

Este documento resume los componentes Angular del proyecto AdoptMe y la funcionalidad principal de cada uno. La aplicacion esta organizada en componentes standalone, con paginas enrutadas en `src/app/pages` y componentes reutilizables en `src/app/shared`.
...
- Agenda:
  ...
  - Lunes a viernes: citas de 10:00 a 18:00.
  - Sabados: citas de 09:00 a 13:00.
